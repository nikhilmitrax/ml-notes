    ...
    return (
        <Section title="Batch Normalization (BatchNorm)" icon={Layers}>
            ...
            <div className="mt-6 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Training vs. Inference Behavior</h3>
                <p className="mb-4 text-gray-700 dark:text-gray-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h4 className="font-bold text-blue-600 dark:text-blue-400 mb-2">Training Mode</h4>
...
running_mean = 0.9 * running_mean + 0.1 * mean`} />
                    ...
                    <div>
                        <h4 className="font-bold text-purple-600 dark:text-purple-400 mb-2">Inference Mode</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
