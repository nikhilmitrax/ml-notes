    ...
    return (
        <Section title="Taxonomy of Modern MoE Architectures" icon={GitBranch}>
            ...
            <div className="space-y-6">
                <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">Sparse MoE Architectures</h4>
                ...
                <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">Dense-Hybrid MoE Architectures</h4>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">
                ...
                <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">Hierarchical and Structured MoE Architectures</h4>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">
                ...
                <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">Joint MoE and Multimodal Architectures</h4>
                    <p className="text-gray-700 dark:text-gray-300 mt-1">
