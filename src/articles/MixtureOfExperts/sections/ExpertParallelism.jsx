        ...
        <Section title="Expert Parallelism" icon={Server}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-2">Data Parallelism</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                        Replicates the full model on every GPU. Good for small models.
                    </p>
                </div>
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                    <h4 className="font-bold text-blue-900 dark:text-blue-100 mb-2">Expert Parallelism</h4>
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-6 mb-3">All-to-All Communication</h3>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
