    ...
    return (
        <Section title="Overview and definition" icon={Brain}>
            <div className="space-y-6">
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">What counts as "reasoning" for LLMs?</h3>
                <ul className="list-disc pl-6 space-y-2">
                    <li>
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">Interfaces that elicit reasoning</h3>
                <p>
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">The role of scaling and the "aha" phenomenon</h3>
                <p>
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">A minimal mathematical lens</h3>
                <p>
