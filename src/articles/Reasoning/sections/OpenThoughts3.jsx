    ...
    return (
        <Section title="OpenThoughts3: Large-Scale Open Reasoning Dataset" icon={Database}>
            <div className="space-y-6">
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">Design and Pipeline</h3>
                <p>
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">Evaluation Framework</h3>
                <p>
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">Results and Scaling Behavior</h3>
                <p>
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">Model Progression and Impact</h3>
                <p>
