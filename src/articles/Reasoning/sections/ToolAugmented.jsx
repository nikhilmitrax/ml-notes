    ...
    return (
        <Section title="Tool-Augmented Reasoning" icon={GitBranch}>
            <div className="space-y-6">
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">ReAct: Reason and Act Framework</h3>
...
Thought: That confirms Einstein’s 1905 paper.`}
                    ...
                    <li>
                        ...
                        <p className="mt-2">Formally, the reasoning trajectory is:</p>
                        <EquationBlock><Equation>
                ...
                <h4 className="text-xl font-semibold text-slate-800 mt-6">Extensions</h4>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mt-8">Toolformer and Self-Supervised Tool Learning</h3>
                <h4 className="text-xl font-semibold text-slate-800 mt-6">Core Idea</h4>
                <p>
                ...
                <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <li>
                        ...
                        <p className="mt-2">Formally, the tool-augmented generation process is modeled as:</p>
                        <EquationBlock><Equation>
                ...
                <h4 className="text-xl font-semibold text-slate-800 mt-6">Representative Systems</h4>
                <ol className="list-decimal pl-6 space-y-2">
                ...
                <h4 className="text-xl font-semibold text-slate-800 mt-6">Relationship to ReAct and RL</h4>
                <ul className="list-disc pl-6 space-y-2">
