    ...
    return (
        <Section title="Reinforcement Learning-Based Reasoning" icon={Zap}>
            <div className="space-y-6">
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">WebGPT</Header3>
                <Paragraph>
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">DeepSeek-R1</Header3>
                <Paragraph>
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">DeepSeek-R1 Highlights</Header4>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">Reinforcement Learning for Tool-Integrated Reasoning</Header3>
                <Paragraph>
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Tool-Integrated Reinforcement Learning (ToRL)</Header4>
                <Paragraph>
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Reinforcement Learning for Strategic Tool Use (ReTool)</Header4>
                <Paragraph>
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Tool-Integrated Reinforcement Learning for LLM Judges (TIR-Judge)</Header4>
                <Paragraph>
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">Tool-Augmented Reward Modeling (Themis)</Header3>
                <Paragraph>
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">Tool Learning with Foundation Models</Header3>
                <Paragraph>
