    ...
    return (
        <Section title="ARC and Science QA Benchmarks (ARC-AGI-1 and ARC-AGI-2)" icon={LayoutGrid}>
            <div className="space-y-6">
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">ARC-AGI-1 (Original ARC Challenge)</Header3>
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Dataset Overview</Header4>
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Why it matters for reasoning</Header4>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Evaluation</Header4>
                <ul className="list-disc pl-6 space-y-2">
                    <li>
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Key baselines</Header4>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">ARC-AGI-2 (The Abstraction and Generalization Intelligence benchmark)</Header3>
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Motivation</Header4>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Design</Header4>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Dataset composition</Header4>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <Header4 className="text-xl font-semibold text-slate-800 mt-6">Why it matters</Header4>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">Comparative insights: ARC vs. ARC-AGI-2</Header3>
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">Empirical trends</Header3>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <Header3 className="text-2xl font-semibold text-slate-800 mt-8">Practical evaluation guidance</Header3>
