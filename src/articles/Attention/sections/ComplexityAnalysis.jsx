...
const ComplexityAnalysis = () => {
    return (
        <Section title="Complexity Analysis" icon={Activity}>
            ...
            <Header4 className="font-bold text-slate-800 mb-3 mt-6">MQA Complexity</Header4>
            <Paragraph className="mb-2 text-slate-700"><strong>Key design</strong>: Only one set of keys and values is computed and cached, regardless of the number of attention heads.</Paragraph>

            <div className="bg-blue-50 p-4 rounded-lg mb-6">
                <Paragraph className="font-semibold text-blue-900 mb-2">Memory and Compute Savings:</Paragraph>
                ...
                <Paragraph className="text-blue-800 mt-2"><strong>Result</strong>: MQA makes inference sub-quadratic — in fact, linear with respect to sequence length for each token step.</Paragraph>
            </div>

            <Header4 className="font-bold text-slate-800 mb-3">GQA Complexity</Header4>
            <Paragraph className="mb-2 text-slate-700"><strong>Key design</strong>: KV projections are shared within groups of attention heads. With <Equation>{`G`}</Equation> groups, you store only <Equation>{`G`}</Equation> sets of keys/values, where <Equation>{`G < H`}</Equation>.</Paragraph>

            <div className="bg-green-50 p-4 rounded-lg mb-6">
                <Paragraph className="font-semibold text-green-900 mb-2">Memory and Compute:</Paragraph>
                ...
                <Paragraph className="text-green-800 mt-2"><strong>Result</strong>: GQA is also sub-quadratic, with a tunable balance between memory efficiency (via <Equation>{`G`}</Equation>) and expressiveness.</Paragraph>
            </div>

            <Header4 className="font-bold text-slate-800 mb-3">Tabular Summary</Header4>
