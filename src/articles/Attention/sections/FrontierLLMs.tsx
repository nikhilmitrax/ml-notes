...
const FrontierLLMs = () => {
    return (
        <Section title="Attention in Frontier LLMs" icon={Cpu}>
            ...
            <Header3 className="text-xl font-semibold text-slate-800 mb-4">Linear Attention (Linformer)</Header3>
            ...
            <Header3 className="text-xl font-semibold text-slate-800 mb-4">Lightning Attention</Header3>
            <Paragraph className="mb-4 text-slate-700 leading-relaxed">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Core Algorithm Steps</Header4>
    ...
    return O`}</pre>
            ...
            <Header3 className="text-xl font-semibold text-slate-800 mb-4">Multi-Query Attention (MQA)</Header3>
            <Paragraph className="mb-4 text-slate-700 leading-relaxed">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Why Multi-Query Attention Works</Header4>
            <ul className="list-disc list-inside text-slate-700 space-y-2 mb-6 ml-4">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Benefits of Multi-Query Attention</Header4>
            <ul className="list-disc list-inside text-slate-700 space-y-2 mb-6 ml-4">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Use in Modern Models</Header4>
            <Paragraph className="mb-6 text-slate-700 leading-relaxed">
            ...
            <Header3 className="text-xl font-semibold text-slate-800 mb-4">Sliding Window Multi-Query Attention (SW-MQA)</Header3>
            <Paragraph className="mb-4 text-slate-700 leading-relaxed">
            ...
            <Paragraph className="mt-4 mb-4 text-slate-700 leading-relaxed">
            ...
            <Header3 className="text-xl font-semibold text-slate-800 mb-4">Grouped-Query Attention (GQA)</Header3>
            <Paragraph className="mb-4 text-slate-700 leading-relaxed">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Motivation and Benefits</Header4>
            <ul className="list-disc list-inside text-slate-700 space-y-2 mb-6 ml-4">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">How it Works</Header4>
            <Paragraph className="mb-2 text-slate-700">Suppose a Transformer model has:</Paragraph>
            ...
            <Paragraph className="mb-2 text-slate-700 leading-relaxed">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Adoption in Modern LLMs</Header4>
            <Paragraph className="mb-6 text-slate-700 leading-relaxed">
            ...
            <Header3 className="text-xl font-semibold text-slate-800 mb-4 mt-8">Multi-Head vs. Multi-Query vs. Grouped-Query Attention</Header3>
            <Paragraph className="mb-4 text-slate-700 leading-relaxed">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Key Differences</Header4>
            <ul className="list-disc list-inside text-slate-700 space-y-2 mb-6 ml-4">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Comparative Analysis</Header4>
            <Paragraph className="mb-4 text-slate-700 leading-relaxed">
            ...
            <Paragraph className="mb-8 text-slate-700 leading-relaxed">
            ...
            <Header3 className="text-xl font-semibold text-slate-800 mb-4">Multi-Head Latent Attention (MLA)</Header3>
            <Paragraph className="mb-4 text-slate-700 leading-relaxed">
            ...
            <Header4 className="font-bold text-slate-800 mb-3">Key Equations and Design</Header4>
            <Paragraph className="mb-4 text-slate-700 leading-relaxed">
