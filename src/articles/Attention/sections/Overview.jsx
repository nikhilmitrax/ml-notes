...
const Overview = () => {
    return (
        <Section title="Overview" icon={Box}>
            <h3 className="text-xl font-semibold text-slate-800 mb-4">The Attention Mechanism</h3>
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-4">The Bottleneck Problem</h3>
            <p className="mb-4 text-slate-700 leading-relaxed">
            ...
            <div className="bg-red-50 p-6 rounded-lg border border-red-100 mb-8">
                <h4 className="font-semibold text-red-800 mb-3">The Context Vector Bottleneck</h4>
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-4">How Attention Solves the Bottleneck Problem</h3>
            <p className="mb-4 text-slate-700 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-4">Dynamic Focus on Relevant Input Parts</h3>
            <p className="mb-4 text-slate-700">Here is how the attention mechanism works in detail:</p>
            ...
            <p className="mb-4 text-slate-700">By allowing the model to focus on different parts of the input sequence as needed, attention provides several benefits:</p>
